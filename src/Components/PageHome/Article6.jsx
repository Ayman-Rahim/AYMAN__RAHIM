...
import  smartHopital from "../../Assets/article4/wep1.jpg";
import hopital from "../../Assets/article4/wep2.jpg"
    ...
    <div ref={container} className="container_article4">
        <div className="contenttt">
            ...
            <div className="side_description">
                <motion.h2 style={{ opacity : opacity, y : xl, transition : '1s' }}>A Stylized Melee Weapons Models</motion.h2>
